...
export const LANG_EN_TRANS = {
    ...
    'nav.messages': ' Story 01',
    'nav.login' : 'Login',
    'nav.home' : 'Home',
    'nav.about': 'About us',
    'nav.faq': 'FAQ',
    'nav.matches': 'Story 02',
    'nav.statistics': 'Story 03',
    'nav.manOfTheMatch': 'Story 04',
    'nav.teams': 'Story 05',
    'nav.teams.create' : 'Create a team',
    'nav.team': 'Optional 01',
    'nav.doodle': 'Optional 02',
    'nav.profile': 'Profile',
    'nav.logout': 'Logout',
    'nav.contact': 'Contact',
